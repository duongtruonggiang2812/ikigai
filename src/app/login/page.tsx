        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
          ...
          {mode === "forgot" ? (
            <div>
              ...
              <h2 className="text-base font-black text-gray-900 mb-1">Quên mật khẩu?</h2>
              <p className="text-xs text-gray-400 mb-5">Nhập email, chúng tôi sẽ gửi link đặt lại mật khẩu.</p>
